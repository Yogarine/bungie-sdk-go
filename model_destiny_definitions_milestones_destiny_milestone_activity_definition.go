...
type DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition struct {
	...
	ConceptualActivityHash int32 `json:"conceptualActivityHash,omitempty"`
	...
	Variants map[string]DestinyDefinitionsMilestonesDestinyMilestoneActivityVariantDefinition `json:"variants,omitempty"`
}
