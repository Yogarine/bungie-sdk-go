...
type DestinyDefinitionsPresentationDestinyPresentationNodeDefinition struct {
	...
	RootViewIcon string `json:"rootViewIcon,omitempty"`
	NodeType DestinyDestinyPresentationNodeType `json:"nodeType,omitempty"`
	...
	CompletionRecordHash int32 `json:"completionRecordHash,omitempty"`
	// The child entities contained by this presentation node.
	Children DestinyDefinitionsPresentationDestinyPresentationNodeChildrenBlock `json:"children,omitempty"`
	// A hint for how to display this presentation node when it's shown in a list.
	DisplayStyle DestinyDestinyPresentationDisplayStyle `json:"displayStyle,omitempty"`
	// A hint for how to display this presentation node when it's shown in its own detail screen.
	ScreenStyle DestinyDestinyPresentationScreenStyle `json:"screenStyle,omitempty"`
	...
	DisableChildSubscreenNavigation bool `json:"disableChildSubscreenNavigation,omitempty"`
