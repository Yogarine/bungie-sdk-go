...
type DestinyDefinitionsMilestonesDestinyMilestoneDefinition struct {
	...
	ShowInMilestones bool `json:"showInMilestones,omitempty"`
	...
	ExplorePrioritizesActivityImage bool `json:"explorePrioritizesActivityImage,omitempty"`
	...
	VendorsDisplayTitle string `json:"vendorsDisplayTitle,omitempty"`
	...
	Activities []DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityDefinition `json:"activities,omitempty"`
	DefaultOrder int32 `json:"defaultOrder,omitempty"`
