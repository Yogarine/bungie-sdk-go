...
type DestinyDefinitionsDestinyNodeStepDefinition struct {
	...
	NodeStepHash int32 `json:"nodeStepHash,omitempty"`
	...
	PerkHashes []int32 `json:"perkHashes,omitempty"`
	...
	StatHashes []int32 `json:"statHashes,omitempty"`
	...
	SocketReplacements []DestinyDefinitionsDestinyNodeSocketReplaceResponse `json:"socketReplacements,omitempty"`
}
