...
type DestinyEntitiesItemsDestinyItemInstanceComponent struct {
	...
	UnlockHashesRequiredToEquip []int32 `json:"unlockHashesRequiredToEquip,omitempty"`
	...
	CannotEquipReason DestinyEquipFailureReason `json:"cannotEquipReason,omitempty"`
}
