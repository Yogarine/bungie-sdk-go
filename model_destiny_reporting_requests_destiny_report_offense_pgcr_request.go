...
type DestinyReportingRequestsDestinyReportOffensePgcrRequest struct {
	...
	ReasonCategoryHashes []int32 `json:"reasonCategoryHashes,omitempty"`
	...
	ReasonHashes []int32 `json:"reasonHashes,omitempty"`
	...
	OffendingCharacterId int64 `json:"offendingCharacterId,omitempty"`
}
