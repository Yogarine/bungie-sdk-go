...
type DestinyDefinitionsDestinyVendorItemDefinition struct {
	...
	Currencies []DestinyDefinitionsDestinyVendorItemQuantity `json:"currencies,omitempty"`
	...
	Exclusivity BungieMembershipType `json:"exclusivity,omitempty"`
	...
	IsCrm bool `json:"isCrm,omitempty"`
	...
	RedirectToSaleIndexes []int32 `json:"redirectToSaleIndexes,omitempty"`
	SocketOverrides []DestinyDefinitionsDestinyVendorItemSocketOverride `json:"socketOverrides,omitempty"`
}
