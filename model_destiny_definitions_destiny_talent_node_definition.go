...
type DestinyDefinitionsDestinyTalentNodeDefinition struct {
	...
	PrerequisiteNodeIndexes []int32 `json:"prerequisiteNodeIndexes,omitempty"`
	...
	Steps []DestinyDefinitionsDestinyNodeStepDefinition `json:"steps,omitempty"`
	...
	ExclusiveWithNodeHashes []int32 `json:"exclusiveWithNodeHashes,omitempty"`
