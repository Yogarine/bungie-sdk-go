...
type DestinyDefinitionsDestinyDestinationDefinition struct {
	...
	DefaultFreeroamActivityHash int32 `json:"defaultFreeroamActivityHash,omitempty"`
	...
	ActivityGraphEntries []DestinyDefinitionsDestinyActivityGraphListEntryDefinition `json:"activityGraphEntries,omitempty"`
	...
	BubbleSettings []DestinyDefinitionsDestinyDestinationBubbleSettingDefinition `json:"bubbleSettings,omitempty"`
	...
	Bubbles []DestinyDefinitionsDestinyBubbleDefinition `json:"bubbles,omitempty"`
