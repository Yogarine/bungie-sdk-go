...
type DestinyDefinitionsDestinyStatGroupDefinition struct {
	...
	ScaledStats []DestinyDefinitionsDestinyStatDisplayDefinition `json:"scaledStats,omitempty"`
	...
	Overrides map[string]DestinyDefinitionsDestinyStatOverrideDefinition `json:"overrides,omitempty"`
