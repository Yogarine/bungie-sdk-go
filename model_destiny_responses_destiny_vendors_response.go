...
type DestinyResponsesDestinyVendorsResponse struct {
	...
	VendorGroups SingleComponentResponseOfDestinyVendorGroupComponent `json:"vendorGroups,omitempty"`
	...
	Vendors DictionaryComponentResponseOfuint32AndDestinyVendorComponent `json:"vendors,omitempty"`
	...
	Categories DictionaryComponentResponseOfuint32AndDestinyVendorCategoriesComponent `json:"categories,omitempty"`
	...
	Sales DictionaryComponentResponseOfuint32AndDestinyVendorSaleItemSetComponent `json:"sales,omitempty"`
