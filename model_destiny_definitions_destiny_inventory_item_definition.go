...
type DestinyDefinitionsDestinyInventoryItemDefinition struct {
	...
	CollectibleHash int32 `json:"collectibleHash,omitempty"`
	...
	BackgroundColor DestinyMiscDestinyColor `json:"backgroundColor,omitempty"`
	...
	UiItemDisplayStyle string `json:"uiItemDisplayStyle,omitempty"`
	...
	EmblemObjectiveHash int32 `json:"emblemObjectiveHash,omitempty"`
	...
	DoesPostmasterPullHaveSideEffects bool `json:"doesPostmasterPullHaveSideEffects,omitempty"`
	...
	DamageTypeHashes []int32 `json:"damageTypeHashes,omitempty"`
	...
	DefaultDamageTypeHash int32 `json:"defaultDamageTypeHash,omitempty"`
