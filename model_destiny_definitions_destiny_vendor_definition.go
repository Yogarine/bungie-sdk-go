...
type DestinyDefinitionsDestinyVendorDefinition struct {
	...
	DisplayItemHash int32 `json:"displayItemHash,omitempty"`
	...
	UnlockRanges []DatesDateRange `json:"unlockRanges,omitempty"`
	...
	Actions []DestinyDefinitionsDestinyVendorActionDefinition `json:"actions,omitempty"`
	...
	Categories []DestinyDefinitionsDestinyVendorCategoryEntryDefinition `json:"categories,omitempty"`
	// See the categories property for a description of categories and why originalCategories exists.
	OriginalCategories []DestinyDefinitionsDestinyVendorCategoryEntryDefinition `json:"originalCategories,omitempty"`
	// Display Categories are different from \"categories\" in that these are specifically for visual grouping and display of categories in Vendor UI.   The \"categories\" structure is for validation of the contained items, and can be categorized entirely separately from \"Display Categories\", there need be and often will be no meaningful relationship between the two.
	DisplayCategories []DestinyDefinitionsDestinyDisplayCategoryDefinition `json:"displayCategories,omitempty"`
	...
	Interactions []DestinyDefinitionsDestinyVendorInteractionDefinition `json:"interactions,omitempty"`
	...
	InventoryFlyouts []DestinyDefinitionsDestinyVendorInventoryFlyoutDefinition `json:"inventoryFlyouts,omitempty"`
	...
	ItemList []DestinyDefinitionsDestinyVendorItemDefinition `json:"itemList,omitempty"`
	...
	Services []DestinyDefinitionsDestinyVendorServiceDefinition `json:"services,omitempty"`
	...
	AcceptedItems []DestinyDefinitionsDestinyVendorAcceptedItemDefinition `json:"acceptedItems,omitempty"`
	...
	ReturnWithVendorRequest bool `json:"returnWithVendorRequest,omitempty"`
	...
	Locations []DestinyDefinitionsVendorsDestinyVendorLocationDefinition `json:"locations,omitempty"`
	...
	Groups []DestinyDefinitionsDestinyVendorGroupReference `json:"groups,omitempty"`
	...
	IgnoreSaleItemHashes []int32 `json:"ignoreSaleItemHashes,omitempty"`
