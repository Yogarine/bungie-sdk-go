...
type DestinyDefinitionsDestinyActivityDefinition struct {
	...
	OriginalDisplayProperties DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition `json:"originalDisplayProperties,omitempty"`
	...
	SelectionScreenDisplayProperties DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition `json:"selectionScreenDisplayProperties,omitempty"`
	...
	Loadouts []DestinyDefinitionsDestinyActivityLoadoutRequirementSet `json:"loadouts,omitempty"`
	...
	InsertionPoints []DestinyDefinitionsDestinyActivityInsertionPointDefinition `json:"insertionPoints,omitempty"`
	...
	ActivityLocationMappings []DestinyConstantsDestinyEnvironmentLocationMapping `json:"activityLocationMappings,omitempty"`
