...
type DestinyDefinitionsSocketsDestinySocketTypeDefinition struct {
	...
	AlwaysRandomizeSockets bool `json:"alwaysRandomizeSockets,omitempty"`
	IsPreviewEnabled bool `json:"isPreviewEnabled,omitempty"`
	HideDuplicateReusablePlugs bool `json:"hideDuplicateReusablePlugs,omitempty"`
	...
	OverridesUiAppearance bool `json:"overridesUiAppearance,omitempty"`
	AvoidDuplicatesOnInitialization bool `json:"avoidDuplicatesOnInitialization,omitempty"`
	CurrencyScalars []DestinyDefinitionsSocketsDestinySocketTypeScalarMaterialRequirementEntry `json:"currencyScalars,omitempty"`
