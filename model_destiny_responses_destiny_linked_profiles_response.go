...
type DestinyResponsesDestinyLinkedProfilesResponse struct {
	...
	Profiles []DestinyResponsesDestinyProfileUserInfoCard `json:"profiles,omitempty"`
	...
	BnetMembership UserUserInfoCard `json:"bnetMembership,omitempty"`
	...
	ProfilesWithErrors []DestinyResponsesDestinyErrorProfile `json:"profilesWithErrors,omitempty"`
}
