...
type DestinyDefinitionsDirectorDestinyActivityGraphDefinition struct {
	...
	Nodes []DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition `json:"nodes,omitempty"`
	// Represents one-off/special UI elements that appear on the map.
	ArtElements []DestinyDefinitionsDirectorDestinyActivityGraphArtElementDefinition `json:"artElements,omitempty"`
	// Represents connections between graph nodes. However, it lacks context that we'd need to make good use of it.
	Connections []DestinyDefinitionsDirectorDestinyActivityGraphConnectionDefinition `json:"connections,omitempty"`
	...
	DisplayObjectives []DestinyDefinitionsDirectorDestinyActivityGraphDisplayObjectiveDefinition `json:"displayObjectives,omitempty"`
	...
	DisplayProgressions []DestinyDefinitionsDirectorDestinyActivityGraphDisplayProgressionDefinition `json:"displayProgressions,omitempty"`
	// Represents links between this Activity Graph and other ones.
	LinkedGraphs []DestinyDefinitionsDirectorDestinyLinkedGraphDefinition `json:"linkedGraphs,omitempty"`
