...
type DestinyRequestsActionsDestinyInsertPlugsRequestEntry struct {
	...
	SocketArrayType DestinyRequestsActionsDestinySocketArrayType `json:"socketArrayType,omitempty"`
