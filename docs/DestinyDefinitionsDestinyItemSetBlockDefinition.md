...
------------ | ------------- | ------------- | -------------
**ItemList** | [**[]DestinyDefinitionsDestinyItemSetBlockEntryDefinition**](Destiny.Definitions.DestinyItemSetBlockEntryDefinition.md) | A collection of hashes of set items, for items such as Quest Metadata items that possess this data. | [optional] 
