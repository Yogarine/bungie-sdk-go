...
type DestinyDefinitionsDestinyTalentGridDefinition struct {
	...
	Nodes []DestinyDefinitionsDestinyTalentNodeDefinition `json:"nodes,omitempty"`
	...
	ExclusiveSets []DestinyDefinitionsDestinyTalentNodeExclusiveSetDefinition `json:"exclusiveSets,omitempty"`
	...
	IndependentNodeIndexes []int32 `json:"independentNodeIndexes,omitempty"`
	...
	Groups map[string]DestinyDefinitionsDestinyTalentExclusiveGroup `json:"groups,omitempty"`
	...
	NodeCategories []DestinyDefinitionsDestinyTalentNodeCategory `json:"nodeCategories,omitempty"`
